...
app.post("/medlynkdevicelistener",function(req,res){
    ...
    //var resmessage=periodic_message();
     //   res.send(resmessage);
     var b=new instance();
     b.get_state_updated(res,b.periodic_message_variable);
...
this.get_state_updated=function get_state_updated(res,exec){   
...
this.validateDevice=function validateDevice(res){
...
this.bulk_message_variable=function bulk_message(){
    ...
    this.periodic_message_variable=function periodic_message(){
