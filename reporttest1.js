...
app.post('/reporting', function(req, res){
  ...
  app.post('/device/networkConfig', function(req, res){
      ...
      var queries=["INSERT INTO home_config (device_id,mac_address,firmware_version,product_model,boot_loader) VALUES('"+logindevid+"',","INSERT INTO data_logger_db.network_config(device_id,ip_address,netMask,gateWay,dns_ip_address,network_interface,dhcp) VALUES('"+logindevid+"',","INSERT INTO serial_config(device_id,rs232_baud_rate,rs232_data_bits,rs232_parity,rs232_stop_bits,rs232_flow_control,rs232_c_timeout,rs485_baud_rate,rs485_data_bits,rs485_parity,rs485_stop_bits,rs485_c_timeout)VALUES('"+logindevid+"',","INSERT INTO data_logger_db.server_config(device_id,ipfiltering,server_connect_wait_time,remote_ip,remote_port_no,connection_inactive_timeout,defeat_long_ack,restart_on_loss_of_link,telnet_IAC,retain_relay_status,data_backup,time_stamp,server_connectivity_timeout,server_connectivity_timeout_related_relay,Relay_initial_state,relay_next_state_duration,login_user_id,login_password,SFD,DLM,packet_try,response_timeout,GSM,APN,gsm_user_id,gsm_password)VALUES('"+logindevid+"',","INSERT INTO data_logger_db.slave_config(device_id,http_post_interval,unit_id,remote_data_path,server_path,ups_query,http_method)VALUES('"+logindevid+"',","INSERT INTO data_logger_db.analog(device_id,ang1_offset,ang1_threshold,ang1_upper_limit,ang1_lower_limit,ang1_method,ang1_relay,ang2_offset,ang2_threshold,ang2_upper_limit,ang2_lower_limit,ang2_method,ang2_relay,ang3_offset,ang3_threshold,ang3_upper_limit,ang3_lower_limit,ang3_method,ang3_relay,ang4_offset,ang4_threshold,ang4_upper_limit,ang4_lower_limit,ang4_method,ang4_relay,ang5_offset,ang5_threshold,ang5_upper_limit,ang5_lower_limit,ang5_method,ang5_relay,ang6_offset,ang6_threshold,ang6_upper_limit,ang6_lower_limit,ang6_method,ang6_relay,ang7_offset,ang7_threshold,ang7_upper_limit,ang7_lower_limit,ang7_method,ang7_relay,ang8_offset,ang8_threshold,ang8_upper_limit,ang8_lower_limit,ang8_method,ang8_relay,master_phone_number,phone_number_1,phone_number_2,phone_number_3,phone_number_4,phone_number_5,phone_number_6,phone_number_7,phone_number_8,phone_number_9,phone_number_10)VALUES('"+logindevid+"',","INSERT INTO data_logger_db.date_time_config(device_id,enable_ntp,ntp_server_ip,ntp_port_no,time_zone,ntp_update_time_interval,rtc_current_date,rtc_current_time)VALUES('"+logindevid+"',","INSERT INTO data_logger_db.digital_count_config(device_id,digi1_pulse_count,digi1_digital_change,digi1_pulse_count_number,digi2_pulse_count,digi2_digital_change,digi2_pulse_count_number,digi3_pulse_count,digi3_digital_change,digi3_pulse_count_number,digi4_pulse_count,digi4_digital_change,digi4_pulse_count_number,digi5_pulse_count,digi5_digital_change,digi5_pulse_count_number,digi6_pulse_count,digi6_digital_change,digi6_pulse_count_number,digi7_pulse_count,digi7_digital_change,digi7_pulse_count_number,digi8_pulse_count,digi8_digital_change,digi8_pulse_count_number,digi9_pulse_count,digi9_digital_change,digi9_pulse_count_number,digi10_pulse_count,digi10_digital_change,digi10_pulse_count_number,digi11_pulse_count,digi11_digital_change,digi11_pulse_count_number,digi12_pulse_count,digi12_digital_change,digi12_pulse_count_number)VALUES('"+logindevid+"',"]; 
      var datadbnames={"home":[0,"home_config"],"network":[1,"network_config"],"serial":[2,"serial_config"],"server":[3,"server_config"],"slave":[4,"slave_config"],"analog":[5,"analog"],"datetime":[6,"date_time_config"],"digitalcount":[7,"digital_count_config"]};
